...
export const methods: Method[] = [
  ...
  },
  {
    ...
    design: {
      de: "Studierende überarbeiten ihr Konzept oder einen Abschnitt ihrer Seminararbeit mithilfe des Konzept-Feedback-Agenten oder eines anderen KI-Tools. Parallel führen sie ein strukturiertes Reflexionsprotokoll: (1) Welchen Vorschlag hat die KI gemacht? (2) Habe ich ihn übernommen, verändert oder verworfen? (3) Warum? Das Protokoll wird als Anhang der Arbeit eingereicht und fliesst in die 25% Lernprozess-Bewertung ein.",
      en: "Students revise their proposal or a paper section using the Concept Feedback Agent or another AI tool. In parallel, they keep a structured reflection log: (1) What did the AI suggest? (2) Did I accept, modify, or reject it? (3) Why? The log is submitted as an appendix and feeds into the 25% learning-process grade.",
    },
  },
  {
